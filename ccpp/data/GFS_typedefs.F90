...
!-------------------------
  subroutine coupling_create (Coupling, IM, Model)
    ...
    if (Model%cplflx .or. Model%do_sppt .or. Model%cplchm .or. Model%cplchp .or. Model%ca_global) then
...
!     Coupling%sfc_alb_vis_dif_cpl   = clear_val
   ...
   !-- cellular automata
    ...
    if (Model%cplchm .or. Model%cplchp .or. Model%rrfs_smoke) then
      !--- outgoing instantaneous quantities
...
!-- chem nml variables for FV3/CCPP-Chem
    ...
    real(kind=kind_phys) :: dust_alpha = 2.2
...
!--- END NAMELIST VARIABLES
    ...
    NAMELIST /gfs_physics_nml/                                                              &
                          ...
                          !--- coupling parameters
                               ...
                               cplchm, cplchp, cpl_imp_mrg, cpl_imp_dbg, rrfs_smoke,        &
...
!---------------------------
  subroutine control_chemistry_initialize(Model, tracer_types)
    ...
    use parse_tracers, only: NO_TRACER, get_tracer_index
